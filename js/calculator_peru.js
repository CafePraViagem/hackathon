  ...
  for (let i = 0; i < dados.length; i++) {
    if (dados[i].checked) {
      if (dados[i].value == Peru.hospedagem.hospedagem1.nomeHospedagem1) {
        ...
        dados[i].value == Peru.hospedagem.hospedagem2.nomeHospedagem2
      ) {
        valorSoma = Peru.hospedagem.hospedagem2.valor;
      } else if (
        dados[i].value == Peru.hospedagem.hospedagem3.nomeHospedagem3
      ) {
        valorSoma = Peru.hospedagem.hospedagem3.valor;
      } else if (
        dados[i].value == Peru.hospedagem.hospedagem4.nomeHospedagem4
      ) {
  ...
  for (let i = 0; i < dados.length; i++) {
    if (dados[i].checked) {
      if (dados[i].value == Peru.pontosTuristicos.primeiroPontoTuristico.nome) {
        ...
        dados[i].value == Peru.pontosTuristicos.segundoPontoTuristico.nome
      ) {
        valorSoma =
          valorSoma + Peru.pontosTuristicos.segundoPontoTuristico.valor;
      } else if (
        dados[i].value == Peru.pontosTuristicos.terceiroPontoTuristico.nome
      ) {
        valorSoma =
          valorSoma + Peru.pontosTuristicos.terceiroPontoTuristico.valor;
      }
    }
  }
  return valorSoma;
...
function valorT() {
  ...
  if (
    ...
    R$  ${(632.0 * getNumeroViajantes()).toFixed(
      2
